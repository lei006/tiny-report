<template>
  <div class="text-area-box">
    ...
    <div v-if="!options.isItemEnable" class="text-area"  :class="{'input-box-border':options.isShowBorder,'input-box-disable':!options.isItemEnable, 'input-box-edit-area':options.isItemEnable}" :tabindex="tabindex" :disabled="!options.isItemEnable">{{inputData}}</div>
  </div>
</template>
