...
export default {
  ...
  methods: {
    ...
    elementMove(e) {
      ...
      let pos = {left:this.left, top:this.top}
    ...
    handleMove(e) {
      ...
      if (handle.includes('r')) {
        ...
        let pos_size = {left:this.left, top:this.top, width: this.width, height: this.height}


      this.$emit('resizing', pos_size)
    },
    handleUp(e) {
      this.handle = null
      ...
      if (this.resizing) {
        ...
        let pos_size = {left:this.left, top:this.top, width: this.width, height: this.height}
        this.$emit('resizestop', pos_size)
      }
      if (this.dragging) {
        this.dragging = false

      let pos = {left:this.left, top:this.top}
        this.$emit('dragstop', pos)
      }
